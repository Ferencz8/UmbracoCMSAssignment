...
{
    [Tree("settings", "myHooks", TreeTitle = "Hooks", TreeGroup = "hooksGroup", SortOrder = 5)]
    [PluginController("hookConfiguration")]
    public class HookConfigurationTreeController : TreeController
    {

        private readonly IMenuItemCollectionFactory _menuItemCollectionFactory;

        public HookConfigurationTreeController(ILocalizedTextService localizedTextService,
        ...
        protected override ActionResult<TreeNodeCollection> GetTreeNodes(string id, FormCollection queryStrings)
        {
            ...
            if (id == Constants.System.Root.ToInvariantString())
            {
                ...
                Dictionary<int, string> hooks = new Dictionary<int, string>();
                hooks.Add(1, "Main Hook");

                // loop through our favourite things and create a tree item for each one
                foreach (var thing in hooks)
                {
